...
<body>
    ...
    <div class="margen">
        ...
        <section class="margenTablas">
            <form method="post">
            <input type="submit" style="background-image: url(recursos/tablaDestino.jpg)" alt="submit" id="juan" name="juan" value="">
            <input type="submit" style="background-image: url(recursos/tablaSus.jpg)" alt="submit" id="juan" name="juan" value="">
            <input type="submit" style="background-image: url(recursos/tablaCamionero.png)" alt="submit" id="juan" name="juan" value="">
            <input type="submit" style="background-image: url(recursos/tablaAlmacen.png)" alt="submit" id="juan" name="juan" value="">  
            </form>
        </section>
