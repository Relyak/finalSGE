...
if (isset($_POST['juan'])) {
    ...
    foreach ($result as $row) {
        echo "<tr><td>" . $row["id"] . "</td>"
            ...
            . "<td>" . "<a href='tablas\conductores\crud\deleteGolfer.php?id=".$row["id"]."'>Añadir</a>" . "</td></tr>"
            . "<td>" . "<a href='tablas\conductores\crud\PagEditar.php?id=".$row["id"]."'>Modificar</a>" . "</td></tr>";
        // . $row["apellidos"]. " - "; 
